...
-- CONSTRUCTION (新增)
-- ═══════════════════════════════════
('Brick wall clay','Construction','Brick Wall','Standard Clay Brick','sqft','supply_install','MY_KL',12.00,18.00,15.00,85,'high',NOW()),
('Brick wall clay','Construction','Brick Wall','Standard Clay Brick','sqft','supply_install','MY_JB',10.56,15.84,13.20,62,'high',NOW()),
('Brick wall clay','Construction','Brick Wall','Standard Clay Brick','sqft','supply_install','MY_PG',11.04,16.56,13.80,54,'high',NOW()),
('Brick wall clay','Construction','Brick Wall','Standard Clay Brick','sqft','supply_install','SG',20.00,30.00,25.00,73,'high',NOW()),

('Brick wall AAC','Construction','Brick Wall','Lightweight Block (AAC)','sqft','supply_install','MY_KL',15.00,22.00,18.00,72,'high',NOW()),
('Brick wall AAC','Construction','Brick Wall','Lightweight Block (AAC)','sqft','supply_install','MY_JB',13.20,19.36,15.84,55,'high',NOW()),
('Brick wall AAC','Construction','Brick Wall','Lightweight Block (AAC)','sqft','supply_install','MY_PG',13.80,20.24,16.56,46,'high',NOW()),
('Brick wall AAC','Construction','Brick Wall','Lightweight Block (AAC)','sqft','supply_install','SG',25.00,36.00,30.00,60,'high',NOW()),

('RC Slab Extension','Construction','Extension Work','RC Slab Extension','sqft','supply_install','MY_KL',55.00,80.00,65.00,58,'high',NOW()),
('RC Slab Extension','Construction','Extension Work','RC Slab Extension','sqft','supply_install','MY_JB',48.40,70.40,57.20,44,'high',NOW()),
('RC Slab Extension','Construction','Extension Work','RC Slab Extension','sqft','supply_install','MY_PG',50.60,73.60,59.80,38,'high',NOW()),
('RC Slab Extension','Construction','Extension Work','RC Slab Extension','sqft','supply_install','SG',90.00,132.00,110.00,52,'high',NOW()),

('RC Floor Slab 150mm G25','Construction','RC Floor Slab','150mm G25','sqft','supply_install','MY_KL',28.00,38.00,33.00,65,'high',NOW()),
('RC Floor Slab 150mm G25','Construction','RC Floor Slab','150mm G25','sqft','supply_install','MY_JB',24.64,33.44,29.04,50,'mid',NOW()),
('RC Floor Slab 150mm G25','Construction','RC Floor Slab','150mm G25','sqft','supply_install','MY_PG',25.76,34.96,30.36,42,'mid',NOW()),
('RC Floor Slab 150mm G25','Construction','RC Floor Slab','150mm G25','sqft','supply_install','SG',46.00,63.00,54.50,58,'high',NOW()),

('RC Floor Slab 150mm G30','Construction','RC Floor Slab','150mm G30','sqft','supply_install','MY_KL',32.00,42.00,37.00,48,'mid',NOW()),
('RC Floor Slab 150mm G30','Construction','RC Floor Slab','150mm G30','sqft','supply_install','MY_JB',28.16,36.96,32.56,36,'mid',NOW()),
('RC Floor Slab 150mm G30','Construction','RC Floor Slab','150mm G30','sqft','supply_install','MY_PG',29.44,38.64,34.04,30,'mid',NOW()),
('RC Floor Slab 150mm G30','Construction','RC Floor Slab','150mm G30','sqft','supply_install','SG',53.00,69.00,61.00,42,'mid',NOW()),

('Standard plastering','Construction','Plastering','Standard Plaster','sqft','supply_install','MY_KL',3.50,5.50,4.50,95,'high',NOW()),
('Standard plastering','Construction','Plastering','Standard Plaster','sqft','supply_install','MY_JB',3.08,4.84,3.96,72,'high',NOW()),
('Standard plastering','Construction','Plastering','Standard Plaster','sqft','supply_install','MY_PG',3.22,5.06,4.14,60,'high',NOW()),
('Standard plastering','Construction','Plastering','Standard Plaster','sqft','supply_install','SG',5.80,9.00,7.40,85,'high',NOW()),

('Sand-cement screed','Construction','Screed','Sand-Cement','sqft','supply_install','MY_KL',3.00,5.00,4.00,88,'high',NOW()),
('Sand-cement screed','Construction','Screed','Sand-Cement','sqft','supply_install','MY_JB',2.64,4.40,3.52,66,'high',NOW()),
('Sand-cement screed','Construction','Screed','Sand-Cement','sqft','supply_install','MY_PG',2.76,4.60,3.68,56,'high',NOW()),
('Sand-cement screed','Construction','Screed','Sand-Cement','sqft','supply_install','SG',5.00,8.20,6.60,78,'high',NOW()),
...
-- ═══════════════════════════════════
('Floor tiles 300x300 S&I','Tiling','Floor Tiles','300x300','sqft','supply_install','MY_KL',5.50,7.50,6.50,210,'high',NOW()),
('Floor tiles 300x300 S&I','Tiling','Floor Tiles','300x300','sqft','supply_install','MY_JB',4.84,6.60,5.72,158,'high',NOW()),
('Floor tiles 300x300 S&I','Tiling','Floor Tiles','300x300','sqft','supply_install','MY_PG',5.06,6.90,5.98,132,'high',NOW()),
('Floor tiles 300x300 S&I','Tiling','Floor Tiles','300x300','sqft','supply_install','SG',9.00,12.50,10.75,185,'high',NOW()),

('Floor tiles 600x600 S&I','Tiling','Floor Tiles','600x600','sqft','supply_install','MY_KL',8.50,11.50,10.00,178,'high',NOW()),
('Floor tiles 600x600 S&I','Tiling','Floor Tiles','600x600','sqft','supply_install','MY_JB',7.48,10.12,8.80,134,'high',NOW()),
('Floor tiles 600x600 S&I','Tiling','Floor Tiles','600x600','sqft','supply_install','MY_PG',7.82,10.58,9.20,112,'high',NOW()),
('Floor tiles 600x600 S&I','Tiling','Floor Tiles','600x600','sqft','supply_install','SG',14.00,19.00,16.50,155,'high',NOW()),

('Floor tiles 1200x600 S&I','Tiling','Floor Tiles','1200x600','sqft','supply_install','MY_KL',13.00,18.00,15.50,142,'high',NOW()),
('Floor tiles 1200x600 S&I','Tiling','Floor Tiles','1200x600','sqft','supply_install','MY_JB',11.44,15.84,13.64,108,'high',NOW()),
('Floor tiles 1200x600 S&I','Tiling','Floor Tiles','1200x600','sqft','supply_install','MY_PG',11.96,16.56,14.26,92,'high',NOW()),
('Floor tiles 1200x600 S&I','Tiling','Floor Tiles','1200x600','sqft','supply_install','SG',21.50,30.00,25.60,125,'high',NOW()),

('Floor tiles labour only','Tiling','Floor Tiles','600x600','sqft','labour_only','MY_KL',4.00,6.00,5.00,165,'high',NOW()),
('Floor tiles labour only','Tiling','Floor Tiles','600x600','sqft','labour_only','MY_JB',3.52,5.28,4.40,125,'high',NOW()),
('Floor tiles labour only','Tiling','Floor Tiles','600x600','sqft','labour_only','MY_PG',3.68,5.52,4.60,105,'high',NOW()),
('Floor tiles labour only','Tiling','Floor Tiles','600x600','sqft','labour_only','SG',6.60,10.00,8.30,145,'high',NOW()),

('Wall tiles 300x600 S&I','Tiling','Wall Tiles','300x600','sqft','supply_install','MY_KL',7.00,10.00,8.50,195,'high',NOW()),
('Wall tiles 300x600 S&I','Tiling','Wall Tiles','300x600','sqft','supply_install','MY_JB',6.16,8.80,7.48,148,'high',NOW()),
('Wall tiles 300x600 S&I','Tiling','Wall Tiles','300x600','sqft','supply_install','MY_PG',6.44,9.20,7.82,124,'high',NOW()),
('Wall tiles 300x600 S&I','Tiling','Wall Tiles','300x600','sqft','supply_install','SG',11.50,16.50,14.00,170,'high',NOW()),

('Wall tiles 600x1200 S&I','Tiling','Wall Tiles','600x1200','sqft','supply_install','MY_KL',12.00,16.00,14.00,110,'high',NOW()),
('Wall tiles 600x1200 S&I','Tiling','Wall Tiles','600x1200','sqft','supply_install','MY_JB',10.56,14.08,12.32,83,'high',NOW()),
('Wall tiles 600x1200 S&I','Tiling','Wall Tiles','600x1200','sqft','supply_install','MY_PG',11.04,14.72,12.88,70,'high',NOW()),
('Wall tiles 600x1200 S&I','Tiling','Wall Tiles','600x1200','sqft','supply_install','SG',19.80,26.40,23.10,95,'high',NOW()),

('Feature/mosaic tiles','Tiling','Wall Tiles','Feature/Mosaic','sqft','supply_install','MY_KL',15.00,25.00,20.00,98,'high',NOW()),
('Feature/mosaic tiles','Tiling','Wall Tiles','Feature/Mosaic','sqft','supply_install','MY_JB',13.20,22.00,17.60,74,'high',NOW()),
('Feature/mosaic tiles','Tiling','Wall Tiles','Feature/Mosaic','sqft','supply_install','MY_PG',13.80,23.00,18.40,62,'high',NOW()),
('Feature/mosaic tiles','Tiling','Wall Tiles','Feature/Mosaic','sqft','supply_install','SG',24.80,41.00,33.00,85,'high',NOW()),

('Outdoor anti-slip tiles','Tiling','Outdoor/Balcony Tiles','Anti-slip','sqft','supply_install','MY_KL',8.00,12.00,10.00,115,'high',NOW()),
('Outdoor anti-slip tiles','Tiling','Outdoor/Balcony Tiles','Anti-slip','sqft','supply_install','MY_JB',7.04,10.56,8.80,88,'high',NOW()),
('Outdoor anti-slip tiles','Tiling','Outdoor/Balcony Tiles','Anti-slip','sqft','supply_install','MY_PG',7.36,11.04,9.20,74,'high',NOW()),
('Outdoor anti-slip tiles','Tiling','Outdoor/Balcony Tiles','Anti-slip','sqft','supply_install','SG',13.20,19.80,16.50,100,'high',NOW()),
...
-- ELECTRICAL
-- ═══════════════════════════════════
('13A socket point','Electrical','Power Points','13A Socket','point','supply_install','MY_KL',85.00,110.00,95.00,320,'high',NOW()),
('13A socket point','Electrical','Power Points','13A Socket','point','supply_install','MY_JB',74.80,96.80,83.60,242,'high',NOW()),
('13A socket point','Electrical','Power Points','13A Socket','point','supply_install','MY_PG',78.20,101.20,87.40,205,'high',NOW()),
('13A socket point','Electrical','Power Points','13A Socket','point','supply_install','SG',100.00,150.00,125.00,285,'high',NOW()),

('Lighting point','Electrical','Lighting Points','Standard','point','supply_install','MY_KL',45.00,70.00,58.00,285,'high',NOW()),
('Lighting point','Electrical','Lighting Points','Standard','point','supply_install','MY_JB',39.60,61.60,51.04,215,'high',NOW()),
('Lighting point','Electrical','Lighting Points','Standard','point','supply_install','MY_PG',41.40,64.40,53.36,182,'high',NOW()),
('Lighting point','Electrical','Lighting Points','Standard','point','supply_install','SG',75.00,115.00,95.00,250,'high',NOW()),
